...
const InventoryArray = ({ productValues, handleChange, variantIndex }) => {
  return (
    <div>
      <div className="mb-3">
        ...
        <input
          ...
          name="sku"
          value={productValues[variantIndex]?.sku}
        ...
        <div className="mb-3">
          ...
          <div className="form-check">
            <input
              ...
              type="checkbox"
              value={productValues[variantIndex]?.manage_stock}
              checked={
                productValues && productValues[variantIndex]?.manage_stock
              }
              name="manage_stock"
              onChange={handleChange}
            />
        ...
        {productValues[variantIndex] &&
        productValues[variantIndex]?.manage_stock ? (
          <>
            <div className="mb-3">
              ...
              <div className="d-flex gap-2">
                <input
                  ...
                  name="stock_quantity"
                  onChange={handleChange}
                  value={productValues[variantIndex]?.stock_quantity}
                />
                <TooltipMsg
                  text={
            ...
            <div className="mb-3">
              ...
              <div className="d-flex gap-2">
                <select
                  ...
                  value={productValues[variantIndex].backorders_status}
            ...
            <div className="mb-3">
              ...
              <div className="d-flex gap-2">
                <input
                  ...
                  placeholder="quantity"
                  onChange={handleChange}
                  value={productValues[variantIndex]?.stock_threshold}
                />
                <TooltipMsg
                  text={
            ...
            <div className="mb-3">
              <label>
                <input
                  ...
                  onChange={handleChange}
                  checked={
                    productValues[variantIndex]?.quantity_status ===
                    "min_quantity"
                  }
                />
                Min Quantity
              ...
              <div className="mb-3">
                ...
                <div className="d-flex gap-2">
                  <input
                    ...
                    onChange={handleChange}
                    value={productValues[variantIndex]?.min_stock_quantity}
                  />
                  <TooltipMsg
                    text={
                      "Stock quantity. If this is a variable Product this value will be used to control stock for all variations. Unless you define stock at variation level."
          ...
          <>
            <div className="mb-3">
              ...
              <select
                className="form-select"
                value={productValues[variantIndex]?.stock_status}
                name="stock_status"
                onChange={handleChange}
              >
